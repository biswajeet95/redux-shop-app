...
const ProductSinglePage = () => {
  ...
  const addToCartHandler = (product) => {
    ...
    dispatch(addToCart({
      ...product, quantity: quantity, totalPrice, discountedPrice
    }));
      ...
      <div className='product-single'>
        <div className='container'>
          <div className='product-single-content bg-white grid'>
            <div className='product-single-1'>
            ...
            <div className='product-single-r'>
              <div className='product-details font-manrope'>
                ...
                <div>
                  <p className='par fw-3 fs-15'>{product?.description}</p>
                </div>
                <div className='info flex align-center flex-wrap fs-14'>
                  ...
                  <div className='brand'>
                    ...
                    <span className='mx-1 text-capitalize'>
                      {product?.category ? product.category.replace("-", "") : ""}</span>
                  </div>
                ...
                <div className='price'>
                  ...
                  <div className='flex align-center my-1'>
                    ...
                    font-poppins fs-24 
                    text-orange'>{formatPrice(discountedPrice)}</div>

                    <div className='discount bg-orange fs-13
                     text-white fw-6 font-poppins'>{product?.discountPercentage}% OFF</div>
                ...
                <div className='qty flex align-center my-4'>
                  ...
                  <div className='qty-change flex align-center mx-3'>
                    <button type="button" className='qty-decrease flex 
                    align-center justify-center' onClick={() => decreaseQty()}>
                      <i className='fas fa-minus'></i>
                    </button>
                    <div className='qty-value flex 
                    align-center justify-center'>{quantity}</div>
                ...
                <div className='btns'>
                  ...
                  <button type="burtton" className='buy-now btn mx-3'>
